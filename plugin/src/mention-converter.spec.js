...
import { $transformTextToMentionNodes, convertToMentionEntries, } from "./mention-converter";
...
describe("mention-converter", () => {
    it("should find mention entries in text", () => {
        ...
        const entries = convertToMentionEntries(text, triggers, DEFAULT_PUNCTUATION);
    ...
    it.skip("should transform mention string to mention nodes", () => {
        ...
        editor.update(() => {
            $convertFromMarkdownString("Hey @catherine, the **task** is #urgent", TRANSFORMERS);
